...
const App = () => {
  ...
  const editionDrop = useEditionDrop("0xE18786594fC8565A9D470f0DcA28653634d543Bd")
  const token = useToken("0xa315bF71B6FFb5081A3805B675B56C0E8CBb6f65")
  const vote = useVote("0x0964b5d2f307D9b23Df9553fd8770b62bA1C4CA0")
  ...
  if (!address) {
    return (
      <div className="landing">
        <h1>Bem-vind@s à JogatinaDAO - a DAO de publicação de games Indie</h1>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        ...
        <p>Parabéns por fazer parte dessa publisher!</p>
        <div>
          <div>
